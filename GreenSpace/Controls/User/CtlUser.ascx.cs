...
namespace GreenSpace.Controls
{
    public partial class CtlUser : System.Web.UI.UserControl
    {
        ...
        public void BindForm(string ID)
        {
            ...
            try { 
            ddRegion.SelectedValue = dr["Region"].ToString();
            DDsemat.SelectedValue = dr["semat"].ToString();
            }
            catch { }
        ...
        protected void BtnUpdate_Click1(object sender, EventArgs e)
        {
            ...
            int i = TaxiDAL.UsersClass.Update(lblUSerIDParam.Text, TXTUserName.Text, null, TXTName.Text, TXTFamlily.Text, TXTmobile.Text, DDsemat.SelectedValue, TXTEmail.Text, TXTMelliCode.Text, TXTPhone.Text, "true",Region:ddRegion.SelectedValue);
            if (i == 0)
            {
                LblMsg.ForeColor = System.Drawing.Color.Red;
                LblMsg.Text = "خطا";
        ...
        protected void BtnInsert_Click1(object sender, EventArgs e)
        {
            ...
            if (!IsRepUserName(TXTUserName.Text, "-1"))
            {
                ...
                int t = TaxiDAL.UsersClass.insert(null, TXTUserName.Text, hash, TXTName.Text, TXTFamlily.Text, TXTmobile.Text, DDsemat.SelectedValue, TXTEmail.Text, TXTMelliCode.Text, TXTPhone.Text, "true",Region: ddRegion.SelectedValue);
                if (t == 0)
                {
                    LblMsg.ForeColor = System.Drawing.Color.Red;
