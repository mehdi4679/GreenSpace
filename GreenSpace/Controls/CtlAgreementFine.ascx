...
<asp:TemplateField HeaderText="ویرایش">
   ...
   <asp:BoundField DataField="PRFineDate"  HeaderText="تاریخ تخلف"   SortExpression="PRFineDate" />
     ...
     <asp:BoundField DataField="NumberFine"  HeaderText="تعداد تخلف"   SortExpression="NumberFine"   />
   <asp:BoundField DataField="AdressFine"  HeaderText="آدرس تخلف"   SortExpression="AdressFine"  />
   <asp:BoundField DataField="FinePrice"  HeaderText="مبلغ تخلف" ItemStyle-CssClass="priceclass"   SortExpression="FinePrice"  ControlStyle-CssClass="priceclass"/>
...
<tr runat="server" id="TrPrimery" visible="false" ><td>ش فرآیند</td><td><asp:textbox Visible="false"   runat="server" ID="TXTAgreementFineID" ></asp:textbox></td><td></td><td>
</td><td></td></tr><tr><td>نوع تخلف</td><td><asp:dropdownlist Width="400px" runat="server" ID="DDFineID" AutoPostBack="true"  OnSelectedIndexChanged="DDFineID_SelectedIndexChanged" ></asp:dropdownlist></td><td></td><td>
</td><td></td></tr><tr><td>تاریخ تخلف</td><td> 
    <uc1:CtlDatePick ID="TXTFineDate" runat="server" />
     
    </td><td></td><td>
</td><td></td></tr>
    <tr><td>مبلغ واحد تخلف</td><td> 
    ...
    <tr><td>تعداد</td><td> 
    <asp:TextBox runat="server" ID="txtNumberFine" Text="1"></asp:TextBox>
    </td><td></td><td>                 
</td><td>                 
                  </td></tr>
    <tr><td>آدرس محل تخلف</td><td> 
    <asp:TextBox runat="server" ID="txtAdressFine" TextMode="MultiLine" Text=""></asp:TextBox>
    </td><td></td><td>                 
</td><td>                 
                  </td></tr>


    <tr><td>توضیحات</td><td><asp:textbox TextMode="MultiLine" runat="server" ID="TXTFineComment" ></asp:textbox></td><td></td><td>
</td><td></td></tr>
</table>
              <div >
              <asp:Button runat="server" Text="ثبت"  ID="BtnInsert" SkinID="btnInsert" OnClick="BtnInsert_Click"
                       ValidationGroup="RVTbl_AgreementFine" style="width: 29px"  />
