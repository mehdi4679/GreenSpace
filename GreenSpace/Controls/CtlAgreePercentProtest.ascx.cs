...
namespace GreenSpace.Controls
{
    public partial class CtlAgreePercentProtest : System.Web.UI.UserControl
    {
        ...
        public void  SetPeymankar(){
            try
            {
                DDProtestStatusID.Items.Remove(DDProtestStatusID.Items[1]);
                DDProtestStatusID.Items.Remove(DDProtestStatusID.Items[1]);
            }
            catch { }
            DDUserResponseID.Visible = false;
        }
        public void  SetPeymankar2(){
            try
            {
                DDProtestStatusID.Items.Remove(DDProtestStatusID.Items[1]);
                DDProtestStatusID.Items.Remove(DDProtestStatusID.Items[1]);
        ...
        public ClAgreePercentProtest Data
        {
            get
            {
                ...
                cl.UserResponseID = Convert.ToInt32(DDUserResponseID.SelectedValue == "" ? "0" : DDUserResponseID.SelectedValue);
        ...
        {
            get { return Convert.ToInt32(LblUserResponseID.Text); }
            set { LblUserResponseID.Text = value.ToString();
            lightinserttrfgd.Visible = false;
            }
        } 
        public bool vvdd
        {
            get { return trmmm.Visible; }
            set { trmmm.Visible = value; }
        }
        public bool VisibleResponsiveDD
        {
            get { return trmmm.Visible; }
            set { trmmm.Visible = value; }
        }
 public bool VisibleResponsiveDD2
        {
            get { return trmmm.Visible; }
            set { trmmm.Visible = value; }
        }
