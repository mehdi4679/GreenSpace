...
<div>
    <table>
        <tr><td>منطقه:</td><td><asp:DropDownList runat="server" ID="dddistincttt" AutoPostBack="True" OnSelectedIndexChanged="dddistincttt_SelectedIndexChanged"></asp:DropDownList></td></tr>
    </table>
</div>
