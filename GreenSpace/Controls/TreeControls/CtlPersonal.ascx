...
<tr runat="server" id="TrPrimery" ><td></td><td><asp:textbox Visible="false"   runat="server" ID="TXTPersonalID" ></asp:textbox></td><td></td><td>
                         ...
                         <asp:Button runat="server"  Text="جستجو" ID="BtnMell" SkinID="hbtn-search-r" OnClick="BtnMell_Click" Visible="false"  />   
...
</td><td><asp:textbox runat="server" ID="TXTPassWord" Visible="False" ></asp:textbox></td></tr><tr><td>&nbsp;</td><td><asp:textbox runat="server" ID="TXTEmail" Visible="False" ></asp:textbox></td><td></td><td>
</td><td><asp:textbox runat="server" ID="TXTManage" Visible="False" ></asp:textbox></td></tr>
</table>
              <div >
             ...
             <asp:Button runat="server"  Text="ویرایش" ID="BtnUpdate" SkinID="btnOk" 
                      Visible="false" ValidationGroup="RVTbl_Personal" OnClick="BtnUpdate_Click1"  />     
                         <asp:Button runat="server"  Text="جستجو" ID="BtnSerach" SkinID="hbtn-search-r" OnClick="BtnSerach_Click" Visible="true" />   
...
<%--   <asp:BoundField DataField="JobName"  HeaderText="JobName"   SortExpression="JobName" />
   ...
   <asp:BoundField DataField="Manage"  HeaderText="Manage"   SortExpression="Manage" />--%>
            ...
            <ItemTemplate>
                        <a id="AEdit3"  class="AEdit"  href='<%# DataBinder.Eval(Container,"DataItem.PersonalID")%>' title="ویرایش" onserverclick="SabCuttingTreet" runat="server" ><span class="fa fa-arrow-left"></span></a>
            </ItemTemplate>
             </asp:TemplateField>
