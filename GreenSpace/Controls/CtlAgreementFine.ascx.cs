    ...
    public partial class CtlAgreementFine : System.Web.UI.UserControl
    {
        public ClAgreementFine Data
        {
            get
            {
                ...
                cl.AdressFine = txtAdressFine.Text;
                cl.NumberFine = Convert.ToInt32(txtNumberFine.Text);
            ...
            set
            {
                ...
                txtNumberFine.Text = dr["NumberFine"].ToString();
                txtAdressFine.Text = dr["AdressFine"].ToString();
        ...
        public void BindDD()
        {
            ...
            ds.Dispose();
            TXTFineDate.Text = DateConvert.m2sh(DateTime.Now.ToString()).ToString();
        ...
        protected void BtnInsert_Click(Object sender, System.EventArgs e)
        {
            //if (TXTFineDate.Text == "")
            //    return;
            if (txtAdressFine.Text == "" || TXTFineComment.Text == "" || DDFineID.Text == "" || TXTFineDate.Text == "" || TXTFinePrice.Text == "" || txtNumberFine.Text == "")
            {
                LblMsg.ForeColor = System.Drawing.Color.Red;
                LblMsg.Text = "تمام اطلاعات باید وارد شوند";
                return;
            }
