    ...
    <div >
     ...
     <asp:Label ID="lblAgreementID"  Visible="false" runat="server" Text="0" ></asp:Label> 
        ...
        <table>
                ...
                <td>پیمان:</td>
                <td>
                    <asp:DropDownList runat="server" ID="DDPeymanSelect" AutoPostBack="True" OnSelectedIndexChanged="DDPeymanSelect_SelectedIndexChanged"></asp:DropDownList>
                 </td>
                </tr>  
            ...
            <tr>
                <td>شرح کار</td><td><asp:dropdownlist runat="server" ID="DDSubjectExplainID" AutoPostBack="True" OnSelectedIndexChanged="DDSubjectExplainID_SelectedIndexChanged"  ></asp:dropdownlist></td><td></td><td>
</td><td></td>
            </tr>
            <tr> 
                <td colspan="100">
    ...
    <tr><td>مقدار واحد</td><td><asp:textbox runat="server" ID="TXTUnitNumber"  ></asp:textbox></td><td></td><td>
            ...
            <tr>
                <td>
                    ...
                    <asp:Button runat="server" Text="ثبت در کل پارکها"  ID="BtnInsertAllPark" SkinID="btnInsert" 
                      OnClick="BtnInsertAllPark_Click"   ValidationGroup="RVTbl_Area" Visible="false" />
