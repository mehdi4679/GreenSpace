...
namespace GreenSpace.Controls
{
    public partial class CtlPark : System.Web.UI.UserControl
    {
        ...
        public void BindDD() {
            ...
            dddistincttt.DataSource = TaxiDAL.CatalogClass.GetListTypeID("2");
            dddistincttt.DataTextField = "CatalogName";
            dddistincttt.DataValueField = "CatalogValue";
            dddistincttt.DataBind();
       ...
       //     BindPeyman();
        ...
        {
            ClPark cl = new ClPark();
            cl.ParkDistrict = Convert.ToInt32(dddistincttt.SelectedValue);
        ...
        protected void GridView1_Sorting(object sender, System.Web.UI.WebControls.GridViewSortEventArgs e)
        {
            ...
            StrSortDirection = ViewState["ParkID" + "Direction"].ToString();
      ...
      protected void dddistincttt_SelectedIndexChanged(object sender, EventArgs e)
      {
          BindGrid();
      }
