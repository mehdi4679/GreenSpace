...
namespace GreenSpace.Controls
{
    ...
    public partial class CtlRegionPark : System.Web.UI.UserControl
    {
     ...
     public string ViewAllPark{
         get { return lblAllPark.Text; }
         set{lblAllPark.Text=value;}
    }
        public void BindDD()
        {
            BindRegion();
        ...
        private  void BindPArk()
        {
            ...
            ddPArk.DataBind();
            if (lblAllPark.Text == "1" && ddPArk.Items.Count > 0 && ddPArk.Items.FindByValue("-100") == null)
                ddPArk.Items.Insert(0, new ListItem("انتخاب همه", "-100"));
