<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="repsel.aspx.cs"  MasterPageFile="~/Report/RepMaster.master" Inherits="GreenSpace.Bazras.repsel" %>
    ...
    <div>
        <div runat="server" id="dAgree" visible="false" >
            <table>
                <tr>
                    <td>قراردادها:</td>
                    <td> <asp:DropDownList runat="server" ID="ddAgree" AutoPostBack="True" OnSelectedIndexChanged="dd2Agree_SelectedIndexChanged"></asp:DropDownList></td>
...
>
        ...
        <div id="dsubject1" runat="server" visible="false">
         ...
         <br />
        <asp:Button runat="server" SkinID="btnPrn" ID="btnprint21" OnClick="btnprint21_Click" CssClass="DTTT_Print" Text="پرینت" />
...
<iframe  id="MyIfarm1" runat="server" visible="false" width="100%" height="400px" >
