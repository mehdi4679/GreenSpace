   ...
   namespace GreenSpaceDAL
{
    public class PersonalClass
    {
        ...
        public static int insert(String PersonalID, String NationalCode, String FirstName, String LastName, String PersonalAdress, String PostiCode, String PersonalTel, String PersonalMobile, String JobName, String Email, String PassWord, String Manage, String CuttingTreeId, String LicensingTreeid)
{
