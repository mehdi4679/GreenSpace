...
namespace GreenSpaceDAL
{
    public class SubjectClass
    {
        ...
        public static int insert(ClSubject c )

        {

            SqlCommand cmd = new SqlCommand("PRC_Subject_Insert", cnn);
       ...
       cmd.Parameters.Add(new SqlParameter("SubjectName", SqlDbType.NVarChar)).Value =Securenamespace.SecureData.CheckSecurity(c.SubjectName);
        ...
        //---------------------------------------------------------------------------------------------------------
        public static DataSet GetList(ClSubject c)
        {

            SqlCommand cmd = new SqlCommand("PRC_Subject_GetList", cnn);
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
            cmd.Parameters.Add(new SqlParameter("UserIDLog", SqlDbType.NVarChar)).Value = CSharp.PublicFunction.GetUserID();
            cmd.Parameters.Add(new SqlParameter("IpLog", SqlDbType.NVarChar)).Value = CSharp.PublicFunction.GetIPAddress();
            cmd.Parameters.Add(new SqlParameter("OSLog", SqlDbType.NVarChar)).Value = CSharp.PublicFunction.GetOS();
...
cmd.Parameters.Add(new SqlParameter("SubjectName", SqlDbType.NVarChar)).Value = Securenamespace.SecureData.CheckSecurity(c.SubjectName);
        ...
        //---------------------------------------------------------------------------------------------------------
        public static int Update(ClSubject c)
        {

            SqlCommand cmd = new SqlCommand("PRC_Subject_Update", cnn);
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
...
cmd.Parameters.Add(new SqlParameter("SubjectName", SqlDbType.NVarChar)).Value = Securenamespace.SecureData.CheckSecurity(c.SubjectName);
        ...
        //---------------------------------------------------------------------------------------------------------
        public static int Delete(string  SubjectID)
        {

            SqlCommand cmd = new SqlCommand("PRC_Subject_Delete", cnn);
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
        cmd.Parameters.Add(new SqlParameter("UserIDLog", SqlDbType.NVarChar)).Value = CSharp.PublicFunction.GetUserID();
        cmd.Parameters.Add(new SqlParameter("IpLog", SqlDbType.NVarChar)).Value = CSharp.PublicFunction.GetIPAddress();
        cmd.Parameters.Add(new SqlParameter("OSLog", SqlDbType.NVarChar)).Value = CSharp.PublicFunction.GetOS();
   	...
   	cmd.Parameters.Add(new SqlParameter("SubjectID", SqlDbType.Int)).Value =SubjectID ;
