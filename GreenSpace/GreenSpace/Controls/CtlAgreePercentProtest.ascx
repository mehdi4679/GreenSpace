...
</td><td></td></tr><tr><td>وضعیت اعتراض</td><td><asp:dropdownlist runat="server" ID="DDProtestStatusID" ></asp:dropdownlist></td><td></td><td>
</td><td></td></tr><tr><td>تاریخ</td><td> 
    <uc1:CtlDatePick ID="TXTProtestDate" runat="server" />
    </td><td></td><td>
</td><td></td></tr><tr><td>مسول پاسخگویی</td><td><asp:dropdownlist runat="server" ID="DDUserResponseID" ></asp:dropdownlist></td><td></td><td>
...
<%--<asp:TemplateField HeaderText="ویرایش">
            <ItemTemplate>
                        <a id="AEdit" class="AEdit" href='<%# DataBinder.Eval(Container,"DataItem.AgreePercentProtestID")%>' title="ویرایش" onserverclick="UpItem" runat="server" ></a>
            </ItemTemplate>
             </asp:TemplateField>--%>
