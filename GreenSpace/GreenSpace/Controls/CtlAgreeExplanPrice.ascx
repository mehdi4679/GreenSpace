...
<asp:TemplateField HeaderText="فعال">
            <ItemTemplate>
                        <a id="Af" class='<%# Eval("ActID").ToString()=="1" ? "ATrue":"AFalse" %>'    href='<%# DataBinder.Eval(Container,"DataItem.ExplanPriceID")+"$"+Eval("ActID").ToString() %>' title="فعال" onserverclick="ActItem" runat="server" ></a>
            </ItemTemplate>
             </asp:TemplateField>
