    ...
    public partial class CtlCut : System.Web.UI.UserControl
    {
     ...
     DDLicesnceTypeid.DataBind();
        ...
        public void BindGrid()
        {
            ...
            DataSet ds = CuttingTreeClass.GetList(null, null, null, null, null, null, null, null, null, Personelid.ToString(), null, null, null, null, Haghighiid.ToString(), null,null,null );
         if(ds!=null)
            {
        ...
        {
            String id = ((HtmlAnchor)sender).HRef.ToString();
            DataSet ds = CuttingTreeClass.GetList(id, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        {
            DataSet ds = CuttingTreeClass.GetList(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,null,null);
            DataView dv = new DataView(ds.Tables[0]);
        ...
        protected void BtnInsert_Click(Object sender, System.EventArgs e)
        {
            ...
            int t = CuttingTreeClass.insert(null, null, null, TXTdate.Text, TXTAddress.Text, null, null, null, null, chkPeyman.Checked.ToString(), PeymanId, DDMantagheId.SelectedValue.ToString(), chkMojavez.Checked.ToString(), Haghighiid.ToString(), LicesnceTypeid, TXTTitle.Text, TXTDesc.Text);
            if (t == 0)
            {
