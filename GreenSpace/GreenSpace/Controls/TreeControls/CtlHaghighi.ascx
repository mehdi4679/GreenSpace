...
<table>
<tr runat="server" id="TrPrimery" ><td></td><td><asp:textbox Visible="false"   runat="server" ID="TXTHaghighiID" ></asp:textbox></td><td></td><td>
</td><td></td></tr><tr><td>نام شرکت/سازمان</td><td><asp:textbox runat="server" ID="TXTHaghighiName" ></asp:textbox></td><td></td><td>                 <asp:RegularExpressionValidator ID="RVHaghighiName" runat="server" 
                  ControlToValidate="txtHaghighiName" Display="Dynamic" ErrorMessage="فقط عدد وارد کنید" 
...
</td><td></td></tr><tr><td>نام مدیر عامل</td><td><asp:textbox runat="server" ID="TXTManageName" ></asp:textbox></td><td></td><td>
</td><td></td></tr><tr><td>نام خانوادگی مدیر عامل</td><td><asp:textbox runat="server" ID="TXTHaghighiFamily" ></asp:textbox></td><td>&nbsp;</td><td>
    &nbsp;</td><td>&nbsp;</td></tr><tr><td>تلفن ثابت</td><td><asp:textbox runat="server" ID="TXTHaghighiTel" ></asp:textbox></td><td></td><td>
</td><td></td></tr><tr><td>آدرس</td><td><asp:textbox runat="server" ID="TXTHaghighiAdress" ></asp:textbox></td><td></td><td>
</td><td></td></tr><tr><td>موبایل</td><td><asp:textbox runat="server" ID="TXTRepresentativeMobile" ></asp:textbox></td><td></td><td>
</td><td></td></tr><tr><td>ایمیل</td><td><asp:textbox runat="server" ID="TXTHaghighiyEmail" ></asp:textbox></td><td></td><td>
</td><td></td></tr>
</table>
              <div >
              <asp:Button runat="server" Text="افزودن"  ID="BtnInsert" SkinID="btnInsert"   ValidationGroup="RVTbl_Haghighi" OnClick="BtnInsert_Click" />
             ...
             <asp:Button runat="server"  Text="جستجو" ID="BtnSerach" SkinID="hbtn-search-r" OnClick="BtnSerach_Click1" />   
