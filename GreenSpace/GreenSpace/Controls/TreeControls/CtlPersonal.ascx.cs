    ...
    public partial class CtlPersonal : System.Web.UI.UserControl
    {
        ...
        public void BindGrid()
        {
             ...
             if (CuttingTreeId != 0)
            {
                ...
                DataSet ds = PersonalClass.GetList( null, null, null, null, null, null, null, null,null, null, null,null,CuttingTreeId.ToString(),null );
                if (ds != null)
                 dv = new DataView(ds.Tables[0]);
            }
            else if (LicensingTreeId  != 0)
            {
                ...
                DataSet ds = PersonalClass.GetList(  null, null, null, null, null, null, null, null, null,null,null, null,null,LicensingTreeId.ToString());
                if (ds != null)
                    dv = new DataView(ds.Tables[0]);
            }
        ...
        {
            int t = PersonalClass.insert(TXTPersonalID.Text, TXTNationalCode.Text, TXTFirstName.Text, TXTLastName.Text, TXTPersonalAdress.Text, TXTPostiCode.Text, TXTPersonalTel.Text, TXTPersonalMobile.Text, null, null, null, null,CuttingTreeId.ToString(),LicensingTreeId.ToString());
            if (t == 0)
            {
