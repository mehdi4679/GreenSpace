...
namespace GreenSpace
{
    public class Global : System.Web.HttpApplication
    {
        ...
        protected void Application_Error(object sender, EventArgs e)
        {
            ...
            //string sql = "    insert into Tbl_ErrorLog(ErrorLog,createDate)values(N'" + Securenamespace.SecureData.CheckSecurity(lastErrorMessage.ToString()+"IP"+CSharp.PublicFunction.GetIPAddress().ToString()) + "',getdate())";
