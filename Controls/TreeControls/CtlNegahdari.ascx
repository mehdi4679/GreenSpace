<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtlNegahdari.ascx.cs" Inherits="GreenSpace.Controls.CtlNegahdari" %>
...
<asp:TemplateField HeaderText="ویرایش">
   ...
   <asp:BoundField DataField="mony1"  HeaderText="مبلغ"   SortExpression="mony" />
   <asp:BoundField DataField="Opreation1"  HeaderText="نوع عملیات"   SortExpression="AmaliatTypeId" />
   <asp:BoundField DataField="year1"  HeaderText="سال"   SortExpression="year" />
       <asp:BoundField DataField="YearSUM"  HeaderText="جمع کل سال"   SortExpression="YearSUM" />
             </Columns>
</asp:GridView>
        </div>
...
</td><td></td></tr><tr><td>تکرار سالانه</td><td><asp:textbox runat="server" ID="TXTTekrarSalane" ></asp:textbox></td><td></td><td>
</td><td></td></tr><tr><td>مبلغ</td><td><asp:textbox runat="server" ID="TXTmony"   onkeyup="this.value = digitGroup(this.value);"></asp:textbox></td><td></td><td>     
            <%--    <asp:RegularExpressionValidator ID="RVmony" runat="server" 
                  ControlToValidate="txtmony" Display="Dynamic" ErrorMessage="فقط عدد وارد کنید" 
                  ValidationExpression="^[+]?\d*$" SetFocusOnError="True" 
                  ValidationGroup="RVTbl_Negahdari" ForeColor="Red"></asp:RegularExpressionValidator>--%>
</td><td></td></tr><tr><td>نوع عملیات</td><td><asp:dropdownlist runat="server" ID="DDAmaliatTypeId" ></asp:dropdownlist></td><td></td><td>
              ...
              <asp:Button runat="server" Text="افزودن"  ID="BtnInsert" SkinID="btnInsert" 
                      Visible="false"   ValidationGroup="RVTbl_Negahdari" OnClick="BtnInsert_Click" />
             <asp:Button runat="server"  Text="ویرایش" ID="BtnUpdate" SkinID="btnOk" 
                      Visible="false" ValidationGroup="RVTbl_Negahdari" OnClick="BtnUpdate_Click1"  />
