...
namespace GreenSpace.Controls
{
    public partial class CtlHaghighi : System.Web.UI.UserControl
    {
        ...
        {
            string PersonalID = "";
            if ( Session["PersonalID"] != null && Session["PersonalID"] != "0" && Session["PersonalID"] != "")
                PersonalID = Session["PersonalID"].ToString();

            int t =HaghighiClass.insert(TXTHaghighiName.Text,TXTManageName.Text,TXTHaghighiTel.Text,TXTHaghighiAdress.Text,TXTRepresentativeMobile.Text,TXTHaghighiyEmail.Text,TXTHaghighiFamily.Text,PersonalID);
