...
<%--           , <asp:Label  runat="server" ID="txtAgreementID" Text='<%# Eval("AgreementID").ToString() %>' ></asp:Label>
   ...
   <asp:Label Visible="false"  runat="server" ID="lblExplainSubjectID" Text='<%# Eval("ExplainSubjectID").ToString() %>' ></asp:Label>
    ...
    <asp:TemplateField HeaderText="تعداد واحد" >
        <ItemTemplate><asp:TextBox runat="server" ID="txtunitNumberNazer" Text='<%# Eval("unitNumberNazer2").ToString() %>'   CssClass="txt"></asp:TextBox></ItemTemplate>
    </asp:TemplateField>


     <asp:TemplateField HeaderText="درصد کیفیت">
        <ItemTemplate>
             <asp:TextBox runat="server" ID="txtutilityPersent" Text='<%# Eval("utilityPersent").ToString() %>'  CssClass="txt" ></asp:TextBox>
        </ItemTemplate>
    </asp:TemplateField>
    ...
    <asp:TemplateField  HeaderText="ضریب بالاسری">
        ...
        <ItemTemplate><asp:TextBox runat="server" ID="txtJarimeComment" Text='<%# Eval("commentdarsad").ToString() %>'   CssClass="txt"></asp:TextBox></ItemTemplate>
    </asp:TemplateField>
