...
//cmd.Parameters.Add(new SqlParameter("CreateUser", SqlDbType.Int)).Value =Securenamespace.SecureData.CheckSecurity(c.CreateUser==null ? 1:0);
//cmd.Parameters.Add(new SqlParameter("createDate", SqlDbType.NVarChar)).Value = Securenamespace.SecureData.CheckSecurity(c.createDate==null? "":"");
