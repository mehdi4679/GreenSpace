...
cmd.Parameters.Add(new SqlParameter("NumberFine", SqlDbType.NVarChar)).Value = Securenamespace.SecureData.CheckSecurity(c.NumberFine);
cmd.Parameters.Add(new SqlParameter("AdressFine", SqlDbType.NVarChar)).Value = Securenamespace.SecureData.CheckSecurity(c.AdressFine);
        ...
        //---------------------------------------------------------------------------------------------------------
        public static DataSet GetList_Rep(ClAgreementFine c)
        {

            SqlCommand cmd = new SqlCommand("PRC_AgreementFine_GetList_rep", cnn);
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
...
cmd.Parameters.Add(new SqlParameter("FinePrice", SqlDbType.Int)).Value = Securenamespace.SecureData.CheckSecurity(c.FinePrice);
cmd.Parameters.Add(new SqlParameter("FineComment", SqlDbType.NVarChar)).Value = Securenamespace.SecureData.CheckSecurity(c.FineComment);
 cmd.Parameters.Add(new SqlParameter("ArchivID", SqlDbType.NVarChar)).Value = Securenamespace.SecureData.CheckSecurity(c.ArchivID);
