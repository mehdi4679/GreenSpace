<%@ Page Title="سامانه ثبت قطع درخت" Language="C#" MasterPageFile="~/Masters/WizardDashboard.Master" AutoEventWireup="true" CodeBehind="PersonalView.aspx.cs" Inherits="GreenSpace.CityZen.PersonalView" %>

<%@ Register Src="~/Controls/TreeControls/CtlPersonOnly.ascx" TagName="CtlPerson" TagPrefix="uc1" %>

<%@ Register Src="~/Controls/TreeControls/CtlHaghighi.ascx" TagName="CtlCompanyOnly" TagPrefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div id="tabs-1" class="tabs-1" style="display: block; margin-top: 12px">
        <fieldset class="fieldsetdiv">
            <legend class="legenddiv">خرید عوارض برای شخص</legend>
    ...
    <div id="tabs-2" class="tabs-2" style="display: none; margin-top: 12px">
        <fieldset class="fieldsetdiv">
            <legend class="legenddiv">خرید عوارض برای شرکت ها,نهادها,اداره ها و سازمانها</legend>
    ...
    <div class="wizard-actions">
        ...
        <a href="MapRegTree.aspx" data-last="Finish" class="btn btn-success btn-next">مرحله بعدی
