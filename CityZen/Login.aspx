<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="GreenSpace.CityZen.Login" %>
            ...
            <div class="main-content">
                <div class="row">
                    ...
                    <div id="dshahrdariArm" class="  responsive right">
                        <img src="/App_Themes/Theme1/Images/arm2.png" style="position: fixed; top: 5px; right: 5px; width: 15%; height: 35%" />
                    </div>
                        ...
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    ...
                                    <span class="green" style="font-size:28px;">سامانه ثبت درخواست مزاحمت یا قطع درختان فضای سبز  </span>
                                </h1>
                                ...
                                <div id="login-box" class="login-box visible widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            <h4 class="header blue lighter bigger" style="font-family:mitrabold;">
...
<%--                                                <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="txtUserName"
                                            ...
                                            <fieldset>
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <input type="text" runat="server" id="txtUserName" class="form-control" placeholder="کد ملی" style="text-align:left" />
                                            ...
                                            <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <input type="password" class="form-control" id="txtPass" runat="server" placeholder="کلمه عبور" style="text-align:left" />
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationGroup="RVTbl_Personal"
                        ...
                        ValidationExpression="^[a-zA-Z0-9'@&#.\s]{4,10}$" style="display:none"/>
                </div>
                <div class="col-md-4">
